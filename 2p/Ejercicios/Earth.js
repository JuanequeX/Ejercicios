const Planetas = {
  ...
  distancia (planet1, planet2) { 
     let distance = Math.abs(planet1.distanceFromSun - planet2.distanceFromSun)
     return distance;
    }
  }
console.log(Planetas.distancia(Planetas.earth, Planetas.mars).toFixed(2) + " Millones de millas")